...
TEST(Directory, GetParent)
{
    ...
    EXPECT_EQ(Directory::GetParent(u"").ToString(), u"");
...
TEST(Directory, GetDirectories)
{
    ...
    if (directories2.size() == 4)
    {
        EXPECT_EQ(directories2[0], directory2.GetPath());
        EXPECT_EQ(directories2[3], directory5.GetPath());
    }
